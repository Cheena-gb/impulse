...
あとでフラックスクリーナーを使うなら塗らなくてもいいです(クリーナーは染料や顔料も落としてしまうので)。
...
<details><summary>別のキーが反応する(行・列単位)</summary>RP2040周辺の短絡を疑います。はんだが多すぎる場合は回収してください。</details>
<details><summary>それ以外の問題</summary>製作者に連絡してください。</details>

## 組み立て
### スタビライザーの静音化(任意)
スタビライザーを分解して摺動部とワイヤーの端をたっぷりのグリスでコーティングし、組み直します。  
...
この状態でスイッチを挿入していきます。  
バックプレートに光を照らすと四角く沈んで見える場所があります。ここに合わせてゴム足を貼り付けてください。
...
ソケットやダイオードなどに合わせて穴を開けたタイプのフォームシートも対応する予定はありません。ご了承ください。
## ゴム足で傾斜を付ける場合の調整
適当に調整してください。
